...
namespace ASPPracticas.ServiceReference2 {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference2.IPersonaService")]
    public interface IPersonaService {
        ...
        ASPPracticas.ServiceReference2.Persona ObtenerPersona(string nombre);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPersonaService/ObtenerPersona", ReplyAction="http://tempuri.org/IPersonaService/ObtenerPersonaResponse")]
        System.Threading.Tasks.Task<ASPPracticas.ServiceReference2.Persona> ObtenerPersonaAsync(string nombre);
        ...
        ASPPracticas.ServiceReference2.Persona ObtenerPersonaPorId(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPersonaService/ObtenerPersonaPorId", ReplyAction="http://tempuri.org/IPersonaService/ObtenerPersonaPorIdResponse")]
        System.Threading.Tasks.Task<ASPPracticas.ServiceReference2.Persona> ObtenerPersonaPorIdAsync(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPersonaService/PersonaXML", ReplyAction="http://tempuri.org/IPersonaService/PersonaXMLResponse")]
        string PersonaXML();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPersonaService/PersonaXML", ReplyAction="http://tempuri.org/IPersonaService/PersonaXMLResponse")]
        System.Threading.Tasks.Task<string> PersonaXMLAsync();
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPersonaServiceChannel : ASPPracticas.ServiceReference2.IPersonaService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PersonaServiceClient : System.ServiceModel.ClientBase<ASPPracticas.ServiceReference2.IPersonaService>, ASPPracticas.ServiceReference2.IPersonaService {
        ...
        public ASPPracticas.ServiceReference2.Persona ObtenerPersona(string nombre) {
            return base.Channel.ObtenerPersona(nombre);
        }
        
        public System.Threading.Tasks.Task<ASPPracticas.ServiceReference2.Persona> ObtenerPersonaAsync(string nombre) {
            return base.Channel.ObtenerPersonaAsync(nombre);
        }
        
        public ASPPracticas.ServiceReference2.Persona ObtenerPersonaPorId(int id) {
            return base.Channel.ObtenerPersonaPorId(id);
        }
        
        public System.Threading.Tasks.Task<ASPPracticas.ServiceReference2.Persona> ObtenerPersonaPorIdAsync(int id) {
            return base.Channel.ObtenerPersonaPorIdAsync(id);
        }
        
        public string PersonaXML() {
            return base.Channel.PersonaXML();
        }
        
        public System.Threading.Tasks.Task<string> PersonaXMLAsync() {
            return base.Channel.PersonaXMLAsync();
        }
    }
}
