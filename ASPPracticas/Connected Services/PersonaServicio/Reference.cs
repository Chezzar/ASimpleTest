...
namespace ASPPracticas.PersonaServicio {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="PersonaServicio.IPersonaService")]
    public interface IPersonaService {
        ...
        ASPPracticas.PersonaServicio.Persona ObtenerPersona(string nombre);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPersonaService/ObtenerPersona", ReplyAction="http://tempuri.org/IPersonaService/ObtenerPersonaResponse")]
        System.Threading.Tasks.Task<ASPPracticas.PersonaServicio.Persona> ObtenerPersonaAsync(string nombre);
        ...
        ASPPracticas.PersonaServicio.Persona ObtenerPersonaPorId(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IPersonaService/ObtenerPersonaPorId", ReplyAction="http://tempuri.org/IPersonaService/ObtenerPersonaPorIdResponse")]
        System.Threading.Tasks.Task<ASPPracticas.PersonaServicio.Persona> ObtenerPersonaPorIdAsync(int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPersonaServiceChannel : ASPPracticas.PersonaServicio.IPersonaService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PersonaServiceClient : System.ServiceModel.ClientBase<ASPPracticas.PersonaServicio.IPersonaService>, ASPPracticas.PersonaServicio.IPersonaService {
        ...
        public ASPPracticas.PersonaServicio.Persona ObtenerPersona(string nombre) {
            return base.Channel.ObtenerPersona(nombre);
        }
        
        public System.Threading.Tasks.Task<ASPPracticas.PersonaServicio.Persona> ObtenerPersonaAsync(string nombre) {
            return base.Channel.ObtenerPersonaAsync(nombre);
        }
        
        public ASPPracticas.PersonaServicio.Persona ObtenerPersonaPorId(int id) {
            return base.Channel.ObtenerPersonaPorId(id);
        }
        
        public System.Threading.Tasks.Task<ASPPracticas.PersonaServicio.Persona> ObtenerPersonaPorIdAsync(int id) {
